"""
Django settings for CheckYourServer project.
...
SECRET_KEY = 'dcrpp7+)ug^swk!2i8ba(z%dbwxrx36h)k5p@-8qdd#&i@buw5'
...
WSGI_APPLICATION = 'CheckYourServer.wsgi.application'
